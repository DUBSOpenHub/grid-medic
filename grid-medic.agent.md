...
3. **Also update the repo copy**: `edit ~/dev/camp-air-ai-agent-catalog/agents/{agent-id}.agent.md`
...
2. Copy the reverted file back: `cp ~/dev/camp-air-ai-agent-catalog/agents/{agent-id}.agent.md ~/.copilot/agents/`
